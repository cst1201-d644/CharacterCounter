...
//Change all the characters in the string to lowercase
String toLowerCase = inputString.toLowerCase();
//Change all the characters in the string to uppercase
String Caps = inputString.toUpperCase();
//traverse each character in the string.
while (i < inputString.length()) {

//if the current character matches the input character.
if (toLowerCase.charAt(i) == inputCharacter || Caps.charAt(i) == inputCharacter) {
